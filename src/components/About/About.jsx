...
import resume from "../../files/evgeniynovakovskiy2025.pdf";
      ...
      <div className={style.about__content}>
        ...
        <article className={style.about__about_block}>
          <div className={style.about__info_block}>
            ...
            >
              Frontend / React Native разработчик с опытом более 2 лет.
              Специализируюсь на создании веб-сервисов и мобильных приложений на
              React, React Native и TypeScript. Уверенно работаю с REST API,
              Redux Toolkit, Jest, Webpack/Vite и Docker. Умею проектировать
              архитектуру, оптимизировать существующие решения и разрабатывать
              новые продукты с нуля. Ценю чистый код, удобный интерфейс и
              командную работу.
            </p>
            <div
              ref={textRef}
